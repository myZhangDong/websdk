...
gulp.task("toes5", function () {
    return gulp.src("demo/javascript/dist/howto.js")// ES6 源码存放的路径
        .pipe(babel())
...
gulp.task('min', function () {
    // 1. 找到文件
    gulp.src('demo/javascript/dist2/howto.js')
        // 2. 压缩文件
        .pipe(uglify())
        // 3. 另存压缩后的文件
...
gulp.task('auto', function () {
    ...
    gulp.watch('demo/javascript/dist/howto.js', ['toes5']);
    gulp.watch('demo/javascript/dist2/howto.js', ['min']);
